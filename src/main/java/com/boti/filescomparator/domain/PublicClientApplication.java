...
import static com.boti.filescomparator.domain.ParameterValidationUtils.validateNotBlank;
...
public class PublicClientApplication extends AbstractClientApplicationBase implements IPublicClientApplication {
    ...
    private void validateNotNull(String parameters, UserNamePasswordParameters parameters1) {
    }
